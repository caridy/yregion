/*global YAHOO,window,YRegions,YRegion2 */
/** 
...
YRegion2 = window.YRegion2 || function() {
    var obj = {},
        ...
        _bd = null,
        /* messages */
        MSG_REGION_READY  = 'region:ready',
        MSG_CONTENTCHANGE = 'contentchange',
        /* constants */
        CONST_ELEMENT = 'element',
        CONST_REGION  = 'region',
        CONST_YREGION = 'yregion';
    /**
    ...
    function _getSemantic(e) {
      ...
      if (o.event && o.target) {
        o.trigger = obj.getOwnerByClassName(o.target, 'trigger', 5);
        ...
        if (!o.yuibutton && !o.anchor) {
            if ((o.target.get('tagName') == 'INPUT') && (o.input = o.target)) {
                ...
                if (o.select) {
                  o.value = o.select.get(CONST_ELEMENT)[o.select.get(CONST_ELEMENT).selectedIndex].value;
                }
            }
        }
    ...
    _regionAbstraction = {
        ...
        ready: function () {
            ...
            this.node.addClass (CONST_REGION);
        ...
        setContent: function (xpath, bd) {
            ...
            if (el) {
                ...
                el.innerHTML = bd;
                this.bubbling (CONST_REGION, MSG_CONTENTCHANGE, {
                    node: this.node
                });
            }
            return this; /* chaining */
        ...
        get: function (xpath, node) {
            node = node || this.node;
            var el = YAHOO.util.Selector.query(xpath, node.get(CONST_ELEMENT), true); 
        ...
        execute: function (command, args, callback) {
            ...
            if (YAHOO.util.Connect) {
                ...
                that.bubbling (CONST_REGION, 'loading', {
                    type: 'ajax',
                    node: that.node,
                    handle: h,
                    command: command,
    ...
    obj.getOwnerByClassName = function(node, className, level) {
        ...
        if (!node.hasClass(className)) {
            el = YAHOO.util.Dom.getAncestorByClassName (node.get(CONST_ELEMENT), className);
    ...
    obj.getOwnerByTagName = function(node, tagName, level) {
        ...
        if (t.toUpperCase() != tagName) {
            el = YAHOO.util.Dom.getAncestorByTagName (node.get(CONST_ELEMENT), tagName);
            node = (el?new YAHOO.util.Element(el):null);
        }
        return node;
    };
        ...
        root = {
            ...
            actions: {
                'region:ready': function () {
                    var i, m, k;
                    /* the general infrastructure is ready */
                    _bd = this;
                    ...
                    m =  function(e) {
                        ...
                        if (o.target && r) {
                            ...
                            if ((o.target.get(CONST_ELEMENT) == r.node.get(CONST_ELEMENT)) && (t = _bd.Event.getRelatedTarget (e)) && !_bd.Dom.isAncestor(r.container, t)) {
                    ...
                    if (c.actions && this.Lang.isFunction(c.actions[MSG_REGION_READY])) {
                        c.actions[MSG_REGION_READY].apply (this, []);
                    }
    ...
    _initRegion((c.guid?c.guid:CONST_YREGION), root);
